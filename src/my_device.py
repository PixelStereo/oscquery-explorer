...
my_float.set_repetition_filter(ossia.RepetitionFilter(True))
my_float.set_domain(ossia.Domain())
my_float.get_domain().set_min(ossia.Value(1))
my_float.get_domain().set_max(ossia.Value(2))
